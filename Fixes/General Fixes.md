...
If a game does not launch, has save issues, crashes, or has other unexpected problems, you usually need a **fix**.
...
5. Launch the game again and test.

## Notes

- Always read any instructions included with the fix.
- If the game still does not work, try another available fix for that same game.
